...
public class Purse {
     ...
     * @param capacity is maximum number of coins you can put in purse.
     */
    public Purse(int capacity, String strategy) {
     ...
     *
     * @param val is a Valuable object to insert into purse
    ...
    public Valuable[] withdraw(double amount, String currency) {
         ...
         */
        List<Valuable> returnCoin = strategy.withdraw(amount, currency, money);
        if(returnCoin!= null){
